...
<body>
	<div class="container">
		...
		<div class="d-flex ms-4 mb-5">
			...
			<div><a style="text-decoration: none;" class="link-dark fw-bold fs-5" href="${pageContext.request.contextPath}/group_managing/kickedMemberList?num=">강퇴</a></div>
		</div>
					...
					<div class="d-flex pt-3 ps-5 pe-5 pb-5">
						...
						<div class="col pt-4">
							...
							<div class="d-flex mt-1 justify-content-end">
								<div><a style="background-color:rgb(248, 163, 146); width:100px" class="btn" href="${pageContext.request.contextPath}/group_managing/kick?group_num=${tmp.num}">강퇴</a></div>
							</div>
						</div>
					</div>
				</div>
