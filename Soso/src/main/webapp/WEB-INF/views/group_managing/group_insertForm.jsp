	...
	<div id="insert_title">소모임 개설 신청</div>
		<form action="${pageContext.request.contextPath}/group/insert" method="post" id="myForm" enctype="multipart/form-data">
			...
			<div class="form_header">
               ...
               <div class="form_header">
                    <input class="form_input" type="text" name="caption" id="caption" placeholder="이 소모임을 한마디로 표현해주세요!" />
			</div>
               <div>
			...
			<div class="date_pickers">
				<div>
					<label class="form_label" for="ended_dt">모임 모집 마감 일자</label>
					<input class="form_input" type="date" name="deadline_dt" />
				</div>
				<div>
					<label class="form_label" for="start_dt">모임 활동 시작 일자</label>
					<input class="form_input" type="date" name="start_dt" />
				</div>
				<div>
					<label class="form_label" for="ended_dt">모임 활동 종료 일자</label>
					<input class="form_input" type="date" name="ended_dt" />
				</div>
			</div>
			<div>
				<textarea name="manager_comment" id="manager_comment" rows="5" placeholder="이곳에 소모임 규칙 또는 자세한 설명을 적어주세요!"></textarea>
			</div>
			<div id="form_button">
