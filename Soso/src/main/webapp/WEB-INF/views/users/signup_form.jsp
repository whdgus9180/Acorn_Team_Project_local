...
북메이트 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터로 문의 주시기 바랍니다.
				...
				<fieldset class="fieldarea f3">
					...
					<p class="agreeText">
						...
						<textarea id="text2" readonly>개인정보보호법에 따라 북메이트에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
1. 수집하는 개인정보
...
이용자는 개인정보의 수집 및 이용 동의를 거부할 권리가 있습니다. 회원가입 시 수집하는 최소한의 개인정보, 즉, 필수 항목에 대한 수집 및 이용 동의를 거부하실 경우, 회원가입이 어려울 수 있습니다.
				...
				<fieldset class="fieldarea f3">
					...
					<p class="agreeText">
						...
						<textarea id="text3" readonly>북메이트는 개인정보 보호법 제22조 제4항과 제39조의 3에 따라 사용자의 광고성 정보 수신과 이에 따른 개인정보 처리에 대한 동의를 받고 있습니다. 약관에 동의하지 않으셔도 북메이트의 모든 서비스를 이용하실 수 있습니다. 다만 이벤트, 혜택 등의 제한이 있을 수 있습니다.
- 개인정보 수집 항목
